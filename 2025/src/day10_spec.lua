...
local fn_day10_part1 = function()
    ...
    local machines = fun.iter(input)
        :map(function(x)
            ...
            return { diagram = diagram_packed, lights = lights, buttons = buttons_packed, joltages = joltages }
        end, input)
        :totable()
    ...
    local min_pushes = fun.foldl(function(acc, machine)
        ...
        for pushes = 1, #machine.buttons do
            ...
            for _, state in ipairs(states) do
                ...
                for _, b in ipairs(machine.buttons) do
                ...
                for _, v in ipairs(untested_buttons) do
                    ...
                    if lights == machine.diagram then
                        min_pushes = pushes
