...
class Day05 {
    ...
    private fun List<Pair<Coord, Coord>>.calcOverlaps(includeDiagonal: Boolean = false) = this
        .flatMap {
            ...
            else if (includeDiagonal && abs(it.first.x - it.second.x) == abs(it.first.y - it.second.y))
